...
#---------------------------Implémentation de l'algorithme A* avec renvoi d'informations---------------------------

ResultatAstar3d_debug = namedtuple("ResultatAstar3d_debug", ["chemin", "volumeExplore", "surfaceExplore", "voxels"])

def astar3d_debug(depart, tDepart, arrivee, tArrivee, grille, tableReservation, pMax=1000):
    ...
    return ResultatAstar3d_debug(chemin, c, heuristique.c, voxel)
